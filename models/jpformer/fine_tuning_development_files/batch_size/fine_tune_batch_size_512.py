...
def train_patient_model(
    ...
    if best_model_state_dict:
        save_dir = os.path.join(PROJECT_ROOT, "models", "jpformer","fine_tuning_development_files", "batch_size", "batch_size_512", f"patient_{patient_id}")
        create_dir(save_dir)
...
def main():
    # Load configuration
    config_path = os.path.join(PROJECT_ROOT, "models/jpformer/fine_tuning_development_files/batch_size/batch_512_config.json")
    ...
    results_dir = os.path.join(PROJECT_ROOT, "models", "jpformer","fine_tuning_development_files", "batch_size", "batch_size_512")
