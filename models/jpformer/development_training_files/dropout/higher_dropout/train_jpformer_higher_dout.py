...
config_path = os.path.join(PROJECT_ROOT, 'models/jpformer/development_training_files/dropout/higher_dropout/high_dout_config_3_lyr.json')
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(PROJECT_ROOT, "models", "jpformer", "development_training_files", "dropout", "higher_dropout")
