...
config_path = os.path.join(PROJECT_ROOT, 'models/jpformer/development_training_files/dropout/higher_dropout_2_layer/high_dout_config_2_lyr.json')
...
if __name__ == "__main__":
    ...
    model_type = "jpformer_dual_weighted_rmse_loss_func_high_dim_4_enc_lyrs_high_dropout"
    ...
    save_dir = os.path.join(PROJECT_ROOT, "models", "jpformer", "development_training_files", "dropout", "higher_dropout_2_layer")
