...
config_path = os.path.join(PROJECT_ROOT, 'models/jpformer/development_training_files/dropout/no_dropout/no_dout_config.json')
...
if __name__ == "__main__":
    ...
    model_type = "jpformer_dual_weighted_rmse_loss_func_high_dim_4_enc_lyrs_no_dropout"
    ...
    save_dir = os.path.join(PROJECT_ROOT, "models", "jpformer", "development_training_files", "dropout", "no_dropout")
