...
from weighted_loss_training_validation_modules import *
from metrics import *
...
if __name__ == "__main__":
    ...
    model_type = "jpformer_dual_weighted_rmse_loss_func"
    ...
    save_dir = os.path.join(PROJECT_ROOT, "models", "jpformer", "development_training_files", "loss_function", "weighted_rmse")
    os.makedirs(save_dir, exist_ok=True)



    best_model_path = train(train_iter, model, optimizer, lr_scheduler, config, train_loader, val_loader, save_dir)
