...
config_path = os.path.join(PROJECT_ROOT, 'models/jpformer/development_training_files/architecture/layers/4_enc_lyrs/4_enc_lyrs_config.json')
...
if __name__ == "__main__":
    ...
    model_type = "jpformer_dual_weighted_rmse_loss_func_4_enc_lyrs"
    ...
    save_dir = os.path.join(PROJECT_ROOT, "models", "jpformer", "development_training_files", "architecture", "layers", "4_enc_lyrs")
