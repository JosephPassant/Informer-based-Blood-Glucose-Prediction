...
config_path = os.path.join(PROJECT_ROOT, 'models/jpformer/development_training_files/architecture/dimension_and_n_heads/high_dim/high_dim_config.json')
...
if __name__ == "__main__":
    ...
    model_type = "jpformer_dual_weighted_rmse_loss_func_higher_dim"
    ...
    save_dir = os.path.join(PROJECT_ROOT, "models", "jpformer", "development_training_files", "architecture", "dimension_and_n_heads", "high_dim")
