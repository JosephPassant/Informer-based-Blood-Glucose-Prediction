...
config_path = os.path.join(PROJECT_ROOT, 'models/jpformer/development_training_files/architecture/dimension_and_n_heads/low_dim/low_dim_config.json')
...
if __name__ == "__main__":
    ...
    model_type = "jpformer_dual_weighted_rmse_loss_func_lower_dim"
    ...
    save_dir = os.path.join(PROJECT_ROOT, "models", "jpformer", "development_training_files", "architecture", "dimension_and_n_heads", "low_dim")
