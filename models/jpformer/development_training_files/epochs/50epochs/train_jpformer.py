...
config_path = os.path.join(PROJECT_ROOT, "models/jpformer/development_training_files/epochs/50epochs/high_dout_config_2_lyr.json")
...
if __name__ == "__main__":
    ...
    model_type = "jpformer_final_model"
