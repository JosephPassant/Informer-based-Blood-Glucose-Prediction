...
config_path = os.path.join(PROJECT_ROOT, 'models/jpformer/development_training_files/epochs/30epochs/high_dout_config_2_lyr.json')
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(PROJECT_ROOT, "models", "jpformer", "development_training_files", "epochs", "30epochs")
