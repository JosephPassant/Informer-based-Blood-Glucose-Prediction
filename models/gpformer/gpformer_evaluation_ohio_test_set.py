...
sys.path.append(os.path.join(PROJECT_ROOT, "models/gpformer"))
from GPFormer import *
...
def main():
    ...
    pretrained_weights_path = os.path.join(PROJECT_ROOT, "models/gpformer/final_model_training_files/gpformer_final_model_0.5971_MAE_0.4225.pth")
    for patient_id in patient_ids:
        ...
        patient_dir = os.path.join(PROJECT_ROOT, "models", "gpformer", "ohiot1dm_ptid_evaluation", f"patient_{patient_id}")
