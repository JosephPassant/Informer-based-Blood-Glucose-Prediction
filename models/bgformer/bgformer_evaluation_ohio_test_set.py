...
sys.path.append(os.path.join(PROJECT_ROOT, "models/bgformer"))
from BGFormer import *
...
def main():
    ...
    pretrained_weights_path = os.path.join(PROJECT_ROOT, "models/bgformer/final_model_training_files/bgformer_final_model_0.5562_MAE_0.3787.pth")
    for patient_id in patient_ids:
        ...
        patient_dir = os.path.join(PROJECT_ROOT, "models", "bgformer", "ohiot1dm_ptid_evaluation", f"patient_{patient_id}")
